...
A visual reference of all available KPI icons is at `source/_static/kpi-icons/k-icons.html` (generated by `npm run generate-icons`).

### Tabler icons (`ti-outline-*` / `ti-filled-*`)
