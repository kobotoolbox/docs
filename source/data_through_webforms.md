...
**Last updated:** <a href="https://github.com/kobotoolbox/docs/blob/5740a1b48198de377ae56fab047b9bbaf5cbd234/source/data_through_webforms.md" class="reference">17 Jul 2026</a>
...
| Online-Only (single submission) | Allows one submission at a time from the same device and can be used with a <a href="https://support.kobotoolbox.org/data_through_webforms.html#redirecting-users-to-another-webpage-after-submission">redirect link</a> after submission. Users are not prevented from reopening the link to submit data again. |
...
* If the form [displays questions on multiple pages](https://support.kobotoolbox.org/alternative_enketo.html#adding-a-web-form-theme-in-the-formbuilder), users can click the <i class="k-icon-qt-note"></i> **three horizontal lines** in the top right corner to navigate to another section.
