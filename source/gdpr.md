...
**Last updated:** <a href="https://github.com/kobotoolbox/docs/blob/3c391b41bc2fe6c2b84628154fc4239e40c1c391/source/gdpr.md" class="reference">28 Aug 2026</a>
...
Organizations located in the European Union can enter into a [data processing agreement (DPA)](https://www.digisigner.com/online/provideDetailsForTemplateLink.xhtml?linkId=495db186-9c9e-4627-99f7-a943282eeab5) with Kobo.
...
Individuals with a KoboToolbox account can be granted [row-level permissions](https://support.kobotoolbox.org/managing_permissions.html#setting-row-level-permissions) that allow them to view, edit, validate, or delete only specific submissions. These permissions can be limited based on who submitted the data or another column in the data, helping project owners control access to individual records without giving users access to the full dataset.

Users with relevant permissions can delete [individual submissions](https://support.kobotoolbox.org/editing_deleting_data.html#deleting-your-data), [media files](https://support.kobotoolbox.org/managing_media_responses.html#deleting-media-files), and [whole projects](https://support.kobotoolbox.org/managing_projects.html#archiving-and-deleting-projects) from their KoboToolbox account.
...
Organizations that require greater control over their hosting environment and data can use a KoboToolbox [private server](https://www.kobotoolbox.org/enterprise/) or [install](https://github.com/kobotoolbox/kobo-install) and manage their own KoboToolbox instance.
