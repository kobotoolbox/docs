...
**Last updated:** <a href="https://github.com/kobotoolbox/docs/blob/6cc9b4f52d9449541afeaf5c0c35688db163a3c1/source/getting_started_organization_feature.md" class="reference">21 Aug 2026</a>
...
3. **Members:** Team Members continue to have full access to their KoboToolbox account with the benefit of their Team’s usage quotas. 
    ...
    - Members can delete projects only if the project has no submissions. To delete a project that contains submissions, they must first delete all submissions from the project.
...
An invitation to join a Team will expire **14 days** after it is sent. You can **resend the invitation** directly in the <i class="k-icon-more"></i> **More actions** menu of the **Members** view. You can also **cancel an invitation** using the **Remove invitation** option in the <i class="k-icon-more"></i> **More actions** menu.
...
1. Go to your **Account Settings**.
2. Navigate to the **Members** page under **TEAM**.
3. Click the <i class="k-icon-more"></i> **More actions** icon for the user you wish to remove.
4. Select **Remove**.
