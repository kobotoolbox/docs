...
**Last updated:** <a href="https://github.com/kobotoolbox/docs/blob/6f05aaa00b0eaf39e8ec1db4a6529a491fb1c551/source/unique_serial_numbers.md" class="reference">23 Apr 2026</a>
...
This method works best with [web forms](data_through_webforms.md). It
...
In the example, when you preview the deployed form in **web forms**, you should be
...
When you preview the example in web forms, the serial number will be
