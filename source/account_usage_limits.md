...
- **Automatic analysis limit:** The number of AI-generated [analysis requests](https://support.kobotoolbox.org/qualitative_analysis.html) available for open-ended audio question responses.
...
<p class="note">
<strong>Note:</strong> You can monitor submissions and storage for your account in <strong>Account Settings > Usage</strong>, where you can view the total usage for your account and usage by project. For more information, see <a href="https://support.kobotoolbox.org/account_settings.html#usage">Account settings</a>.
</p>
...
<p class="note">
<strong>Note:</strong>
These restrictions do not apply if you exceed your <strong>transcription, translation, or analysis limits.</strong> In those cases, only the affected feature will be unavailable until your quota resets or is increased.   
</p>
...
### Managing automatic analysis limits
