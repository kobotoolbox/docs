...
**Last updated:** <a href="https://github.com/kobotoolbox/docs/blob/6f05aaa00b0eaf39e8ec1db4a6529a491fb1c551/source/matrix_response.md" class="reference">23 Apr 2026</a>
...
<p class="note">
<strong>Note:</strong> Question matrices are supported only in <a href="https://support.kobotoolbox.org/data_through_webforms.html">web forms</a> with the <a href="https://support.kobotoolbox.org/alternative_enketo.html">Grid theme</a> enabled. They are not supported in KoboCollect.
</p>
...
Question matrices are supported only in web forms and require the [Grid theme](https://support.kobotoolbox.org/alternative_enketo.html) to be enabled. They are not supported in KoboCollect.

The question matrix is displayed as a table, with each column representing a question and each row representing an item.

![Question matrix](images/matrix_response/enketo.png)
